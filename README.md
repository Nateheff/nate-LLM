NATE is a transformer-based decoder-only LLM. There is also NateClass which is similar to NATE but has an extra fully connected layer at the end making the model
